# Generated by Django 3.2 on 2024-03-06 14:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), django.core.validators.RegexValidator(regex='^[\\w.@+-]+\\Z'), reviews.validators.validate_username], verbose_name='Имя пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(validators=[reviews.validators.validate_year], verbose_name='Год создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Оценка имеет границы от 1 до 10'), django.core.validators.MaxValueValidator(10, message='Оценка имеет границы от 1 до 10')])),
